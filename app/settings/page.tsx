    ...
    <main className="max-w-4xl mx-auto p-4">
      ...
      <section className="card mt-6">
        ...
        <p>
          ...
          Login terkunci 15 menit setelah 5 kegagalan.
        </p>
        <p className="mt-3 text-amber-300">
          Peringatan: menyimpan password dan 2FA dalam vault yang sama
          meningkatkan risiko. Semua field sensitif opsional.
        </p>
        <p className="mt-3">
